...
H5lock.prototype.initDom = function () {
  ...
  // const str = '<h4 id="title" class="title" style="color:#87888a">请绘制您的图形密码</h4>' +
  //   '<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:#fff;font-size: 10px;display:none;">重置密码</a>';

  // wrap.setAttribute('style', 'position: absolute;top:0;left:15px;right:0;bottom:0;');
  // const canvas = document.createElement('canvas');
  // canvas.setAttribute('id', 'canvas');
  // canvas.style.cssText = 'display: inline-block;margin-top: 76px;';
  // wrap.innerHTML = str;
